...
export default function Button({ children }: ButtonProps) {
  ...
  return (
    <button className="m-2 group relative grid overflow-hidden rounded px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
      <span>
      ...
      <span className="backdrop absolute inset-[1.5px] rounded bg-black transition-colors duration-200 group-hover:bg-pink-700/50" />
