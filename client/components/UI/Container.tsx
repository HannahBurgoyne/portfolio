...
export default function Container(props: Props) {
  return (
    <section className="relative m-10 overflow-hidden rounded-md border border-transparent p-[1px] backdrop-blur-3xl">
      ...
      <div className="inline-flex h-full w-full m-[0.8px] items-center justify-center rounded-md bg-slate-900 md:px-6 sm:py-1 text-white backdrop-blur-3xl whitespace-normal">
        {props.children}
      </div>
    </section>
  )
